...
//initialize menuitems
    ...
    MenuItem mi4_i2 = MenuItem("Profile2",              "Profile 2: 2:15 ");
    MenuItem mi4_i3 = MenuItem("Profile3",              "Profile 3: 5 min");
...
//    MenuItem mi1 = MenuItem("RedLeds",                  "Red Leds        ");
//      MenuItem mi1_i1 = MenuItem("On",                  "On              ");
//      MenuItem mi1_i2 = MenuItem("Off",                 "Off             ");
//    MenuItem mi2_i = MenuItem("Expose-Default",         "Expose - Default");
//    MenuItem mi3 = MenuItem("TimeBased Exp",            "TimeBased Expose");
//      MenuItem mi3_mi1 = MenuItem("Set Time",           "Set Time        ");
//        MenuItem mi3_mi1_i1 = MenuItem("Set minutes",   "Set minutes     ");
//        MenuItem mi3_mi1_i2 = MenuItem("Set seconds",   "Set seconds     ");
//      MenuItem mi3_mi2 = MenuItem("Expose now",         "Expose now      ");
//    MenuItem mi4 = MenuItem("Select Profile",           "Select Profile  ");
...
//  lcd.print("-Exposure Time-"); 
  ...
  // Version 2 menu
  menu.getRoot().add(mi1).addRight(mi2).addRight(mi3).addRight(mi4).addRight(mi5);
  mi4.add(mi4_i1).addRight(mi4_i2).addRight(mi4_i3);
  mi5.add(mi5_i1).addRight(mi5_i2);
  mi5_i2.add(mi5_i2_i1).addRight(mi5_i2_i2).addRight(mi5_i2_i3);

  mi5_i2_i3.addBefore(mi5_i2);
  mi5_i2_i2.addBefore(mi5_i2);
  mi5_i2_i1.addBefore(mi5_i2);
  mi5_i2.addBefore(mi5);
  mi5_i1.addBefore(mi5);
  mi4_i3.addBefore(mi4);
  mi4_i2.addBefore(mi4);
  mi4_i1.addBefore(mi4);
  mi5.addBefore(menu.getRoot());
  mi4.addBefore(menu.getRoot());
  mi3.addBefore(menu.getRoot());
  mi2.addBefore(menu.getRoot());
  mi1.addBefore(menu.getRoot());

  // Version 1 menu
//  menu.getRoot().add(mi1);
//  mi1.addRight(mi2_i).addRight(mi3).addRight(mi4);
//  mi1.add(mi1_i1).addRight(mi1_i2);
//  mi3.add(mi3_mi1).addRight(mi3_mi2);
//  mi3_mi1.add(mi3_mi1_i1).addRight(mi3_mi1_i2);
//
//  mi3_mi1_i2.addBefore(mi3_mi1);
//  mi3_mi1_i1.addBefore(mi3_mi1);
//  mi3_mi2.addBefore(mi3);
//  mi3_mi1.addBefore(mi3);
//  mi1_i2.addBefore(mi1);
//  mi1_i1.addBefore(mi1);
//  mi4.addBefore(menu.getRoot());
//  mi3.addBefore(menu.getRoot());
//  mi2_i.addBefore(menu.getRoot());
//
//  mi1.addBefore(menu.getRoot());
...
void menuChanged(MenuChangeEvent changed){
  ...
  if(newMenuItem.getName()==menu.getRoot()){
      ...
      lcd.setCursor(0,1); //set the start position for lcd printing to the second row
      lcd.print("Main Menu       ");
  } else if(not(newMenuItem.getBefore()->getName()==menu.getRoot())) {
      lcd.setCursor(0,0); //set the start position for lcd printing to the second row
      lcd.print(newMenuItem.getBefore()->getDescription());
      lcd.setCursor(0,1); //set the start position for lcd printing to the second row
...
//      buzzer(1,2);
      //menu.toRoot();  //back to main
      if (currentMenu.getBefore()->getName()==menu.getRoot()) {
        lcd.setCursor(0,1); //set the start position for lcd printing to the second row
        lcd.print("Main Menu       ");
        menu.toRoot();  //back to main
      } else {
...
void  readButtonsOrig(){  //read buttons status
  int reading;
...
//  int buttonRightState=LOW;             // the current reading from the input pin
  ...
  //Enter button
                  ...
                  reading = analogRead(buttonPinEnter);
                  if (reading>0) {reading=1;}
    ...
    //Esc button              
                  ...
                  reading = analogRead(buttonPinEsc);
                  if (reading>0) {reading=1;}
...
//                  reading = digitalRead(buttonPinRight);
                  reading = analogRead(buttonPinRight);
                  if (reading>0) {reading=1;}
...
//                  reading = digitalRead(buttonPinLeft);
                  reading = analogRead(buttonPinLeft);
                  if (reading>0) {reading=1;}
